...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Feb 26. 08:09
...
(2, 'Fő utca', 43, 2, 4000000, 'romos', 1, 1, 1),
(5, 'dffs', 23, 1, 2345, 'sdfg', 1, 2, 0),
(6, 'asd', 12, 10, 123, 'asd', 1, 1, 0);
...
(11, 'string', '473287f8298dba7163a897908958f7c0eae733e25d2e027992ea2edc9bed2fa8', 'string', 'string', 1, 0, 'string', 'string'),
(12, 'stringh', 'c995b0c71ea9cab6ffe3e79356b2b20ba59653a05e8b846a8ef7d8eb8aaca605', 'string', 'string', 1, 1, 'havasim@kkszki.hu', 'string');
